...
fullModel <- lm(logppm~mgstr+source_fac+form_fac+bulk_fac+mgstr_c:source_fac+mgstr_c:bulk_fac+source_fac:bulk_fac,data=streetrx_morphine)
...
```{r}
dotplot(ranef(hier_model3,condVar=TRUE))$state
```